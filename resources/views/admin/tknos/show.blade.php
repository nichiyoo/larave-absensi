<div x-on:keydown.escape="tkno = null" x-show="tkno" x-cloak>
    <div x-cloak x-show="tkno" x-transition.opacity class="fixed inset-0 z-40 bg-zinc-900/80 backdrop-blur-sm"></div>

    <div x-cloak x-show="tkno" x-transition class="fixed inset-0 z-50 flex items-center justify-center">
        <div x-on:click.away="tkno = null"
            ...
            <div class="flex justify-end mb-4">
                <x-button x-on:click="tkno = null" variant="outline"
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" name="nama" placeholder="Nama" class="w-full"
                    x-bind:value="tkno?.user?.name" readonly />
            </div>
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" name="nik" placeholder="NIK" class="w-full"
                    x-bind:value="tkno?.user?.nik" readonly />
            </div>
            ...
            <div class="mb-4" x-show="tkno?.checkin">
                ...
                <div
                    ...
                    <img class="object-cover w-full h-full" x-bind:src="tkno?.checkin?.photo" alt="checkin image" />
                    ...
                    <div
                        ...
                        <p class="text-sm  text-zinc-700 dark:text-zinc-300 flex items-center justify-start space-x-2">
                            ...
                            <span x-text="tkno?.checkin?.latitude"></span>
                            <span x-text="tkno?.checkin?.longitude"></span>
                        </p>
                        ...
                        <p class="text-sm  text-zinc-700 dark:text-zinc-300 flex items-center justify-end space-x-2">
                            ...
                            <span
                                x-text="
                                new Date(tkno?.checkin?.created_at).toLocaleTimeString('id-ID', {
                                    hour: '2-digit',
                                    minute: '2-digit'
                                })
                                "></span>
            ...
            <!-- Checkout -->
            <div class="mb-4" x-show="tkno?.checkout">
                ...
                <div
                    ...
                    <img class="object-cover w-full h-full" x-bind:src="tkno?.checkout?.photo" alt="checkout image" />
                    ...
                    <div
                        ...
                        <p class="text-sm  text-zinc-700 dark:text-zinc-300 flex items-center justify-start space-x-2">
                            <i data-lucide="map-pin" class="w-4 h-4 mr-1"></i>
                            <span x-text="tkno?.checkout?.latitude"></span>
                            <span x-text="tkno?.checkout?.longitude"></span>
                        </p>
                        ...
                        <p class="text-sm  text-zinc-700 dark:text-zinc-300 flex items-center justify-end space-x-2">
                            ...
                            <span
                                x-text="
                        new Date(tkno?.checkout?.created_at).toLocaleTimeString('id-ID', {
                            hour: '2-digit',
                            minute: '2-digit'
                        })
                    "></span>
            ...
            <div class="flex items-center justify-end space-x-2">
                <x-button variant="primary" type="button" x-on:click="tkno = null">Close</x-button>
            </div>
        </div>
    </div>
</div>
