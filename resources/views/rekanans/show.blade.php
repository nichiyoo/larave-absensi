<div x-on:keydown.escape="selected = null" x-show="selected" x-cloak>
    <div x-cloak x-show="selected" x-transition.opacity class="fixed inset-0 z-40 bg-zinc-900/80 backdrop-blur-sm"></div>
    <div x-cloak x-show="selected" x-transition class="fixed inset-0 z-50 flex items-center justify-center">
        <div x-on:click.away="selected = null"
            ...
            <div class="flex justify-end mb-4">
                <x-button x-on:click="selected = null" variant="outline"
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" name="nama" placeholder="Nama" class="w-full"
                    x-bind:value="selected?.nama" readonly />
            </div>
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" name="item" placeholder="Item" class="w-full"
                    x-bind:value="selected?.item" readonly />
            </div>
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" name="pekerjaan" placeholder="Pekerjaan" class="w-full"
                    x-bind:value="selected?.pekerjaan" readonly />
            </div>
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" name="no_permit" placeholder="No Permit" class="w-full"
                    x-bind:value="selected?.no_permit" readonly />
            </div>
            ...
            <div class="mb-4">
                ...
                <x-text-input type="text" name="rekanan" placeholder="Rekanan" class="w-full"
                    x-bind:value="selected?.rekanan" readonly />
            </div>
                ...
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    <div>
                        ...
                        <x-text-input type="text" name="open" placeholder="Jam Open" class="w-full"
                            x-bind:value="selected?.open" readonly />
                    </div>
                    <div>
                        ...
                        <x-text-input type="text" name="close" placeholder="Jam Close" class="w-full"
                            x-bind:value="selected?.close" readonly />
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end space-x-2">
                <x-button variant="primary" type="button" x-on:click="selected = null">Close</x-button>
            </div>
        </div>
    </div>
</div>
